//
//  NativeOnGenericMotionListener.swift
//  Droid
//
...
extension AppKitPackage.ListenersPackage {
    ...
    public var OnGenericMotionListener: OnGenericMotionListenerClass { .init(parent: self, name: "NativeOnGenericMotionListener") }
}

final class NativeOnGenericMotionListener: NativeListener, AnyNativeListener, @unchecked Sendable {
    /// The JNI class name
    class var className: JClassName { "stream/swift/droid/appkit/listeners/NativeOnGenericMotionListener" }
...
public func nativeListenerOnGenericMotion(env: UnsafeMutablePointer<JNIEnv?>, callerClassObject: jobject, uniqueId: jint) -> jboolean {
    guard
...
@_cdecl("Java_stream_swift_droid_appkit_listeners_NativeOnGenericMotionListener_onGenericMotionView")
public func nativeListenerOnGenericMotionView(env: UnsafeMutablePointer<JNIEnv?>, callerClassObject: jobject, uniqueId: jint, sameView: jboolean, vId: jint, v: jobject) -> jboolean {
    guard
        let listener: NativeOnGenericMotionListener = ListenerStore.shared.find(id: uniqueId)
    else { return 0 }
...
@_cdecl("Java_stream_swift_droid_appkit_listeners_NativeOnGenericMotionListener_onGenericMotionEvent")
public func nativeListenerOnGenericMotionEvent(env: UnsafeMutablePointer<JNIEnv?>, callerClassObject: jobject, uniqueId: jint, event: jobject) -> jboolean {
    guard
        let listener: NativeOnGenericMotionListener = ListenerStore.shared.find(id: uniqueId)
    else { return 0 }
...
@_cdecl("Java_stream_swift_droid_appkit_listeners_NativeOnGenericMotionListener_onGenericMotionViewEvent")
public func nativeListenerOnGenericMotionViewEvent(env: UnsafeMutablePointer<JNIEnv?>, callerClassObject: jobject, uniqueId: jint, sameView: jboolean, vId: jint, v: jobject, event: jobject) -> jboolean {
    guard
        let listener: NativeOnGenericMotionListener = ListenerStore.shared.find(id: uniqueId)
    else { return 0 }
    let bool = sameView == 1 ? true : false
...
public final class NativeOnGenericMotionListenerEvent {
