...
//    public class OnSeekBarChangeListenerClass: JClassName, @unchecked Sendable {}
//
//    public var OnSeekBarChangeListener: OnSeekBarChangeListenerClass { .init(parent: self, name: "NativeOnSeekBarChangeListener") }
//}
//
//var _nativeOnSeekBarChangeListeners: [NativeOnSeekBarChangeListener] = []
//
//class NativeOnSeekBarChangeListener: @unchecked Sendable, JObjectable {
