...
extension LayoutParamKey {
    // - Directional Constraints
    static let leftToLeft: LayoutParamKey = "leftToLeft"
    static let leftToRight: LayoutParamKey = "leftToRight"
    static let rightToLeft: LayoutParamKey = "rightToLeft"
    static let rightToRight: LayoutParamKey = "rightToRight"
    static let topToTop: LayoutParamKey = "topToTop"
    static let topToBottom: LayoutParamKey = "topToBottom"
    static let bottomToTop: LayoutParamKey = "bottomToTop"
    static let bottomToBottom: LayoutParamKey = "bottomToBottom"
    static let startToStart: LayoutParamKey = "startToStart"
    static let startToEnd: LayoutParamKey = "startToEnd"
    static let endToStart: LayoutParamKey = "endToStart"
    static let endToEnd: LayoutParamKey = "endToEnd"
    static let baselineToBaseline: LayoutParamKey = "baselineToBaseline"
    // - Dimensions
    static let matchConstraintDefaultWidth: LayoutParamKey = "matchConstraintDefaultWidth"
    static let matchConstraintDefaultHeight: LayoutParamKey = "matchConstraintDefaultHeight"
    static let matchConstraintMinWidth: LayoutParamKey = "matchConstraintMinWidth"
    static let matchConstraintMinHeight: LayoutParamKey = "matchConstraintMinHeight"
    static let matchConstraintMaxWidth: LayoutParamKey = "matchConstraintMaxWidth"
    static let matchConstraintMaxHeight: LayoutParamKey = "matchConstraintMaxHeight"
    static let matchConstraintPercentWidth: LayoutParamKey = "matchConstraintPercentWidth"
    static let matchConstraintPercentHeight: LayoutParamKey = "matchConstraintPercentHeight"
    // - Bias (Alignment)
    static let horizontalBias: LayoutParamKey = "horizontalBias"
    static let verticalBias: LayoutParamKey = "verticalBias"
    // - Chains & Barriers
    static let horizontalChainStyle: LayoutParamKey = "horizontalChainStyle"
    static let verticalChainStyle: LayoutParamKey = "verticalChainStyle"
    static let chainUseRtl: LayoutParamKey = "chainUseRtl"
    // - Circular Positioning
    static let circleConstraint: LayoutParamKey = "circleConstraint"
    static let circleRadius: LayoutParamKey = "circleRadius"
    static let circleAngle: LayoutParamKey = "circleAngle"
    // - Aspect Ratio
    static let dimensionRatio: LayoutParamKey = "dimensionRatio"
    // - View Visibility Behavior
    static let goneTopMargin: LayoutParamKey = "goneTopMargin"
    static let goneBottomMargin: LayoutParamKey = "goneBottomMargin"
    static let goneLeftMargin: LayoutParamKey = "goneLeftMargin"
    static let goneRightMargin: LayoutParamKey = "goneRightMargin"
    static let goneStartMargin: LayoutParamKey = "goneStartMargin"
    static let goneEndMargin: LayoutParamKey = "goneEndMargin"
}
