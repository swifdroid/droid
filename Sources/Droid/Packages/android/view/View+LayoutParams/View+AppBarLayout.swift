...
extension View {
    ...
    public func scrollFlags(_ value: String) -> Self { // TODO: ScrollFlag (should be combined as bitmask)
        if let _ = instance {
            ...
            _layoutParamsToApply.append(.scrollFlags) // TODO: ScrollFlag (should be combined as bitmask)
        }
        return self
    }
    ...
    public func scrollEffect(_ value: String) -> Self { // TODO: AppBarLayout.ChildScrollEffect
        if let _ = instance {
            ...
            _layoutParamsToApply.append(.scrollEffect) // TODO: AppBarLayout.ChildScrollEffect
        }
        return self
    }
    ...
    public func liftOnScroll(_ value: Bool) -> Self {
        if let _ = instance {
            ...
            _layoutParamsToApply.append(.liftOnScroll(value))
        }
        return self
    }
    ...
    public func minHeight(_ value: Int, _ unit: DimensionUnit = .dp) -> Self {
        if let _ = instance {
            ...
            _layoutParamsToApply.append(.minHeight(value, unit))
        }
        return self
    }
    ...
    public func maxHeight(_ value: Int, _ unit: DimensionUnit = .dp) -> Self {
        if let _ = instance {
            ...
            _layoutParamsToApply.append(.maxHeight(value, unit))
        }
        return self
    }
}