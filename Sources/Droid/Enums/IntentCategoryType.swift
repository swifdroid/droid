...
public struct IntentCategoryType: ExpressibleByStringLiteral, StringValuable, Sendable, CustomStringConvertible {
	...
	public static var accessibilityShortcutTarget: Self { "android.intent.category.ACCESSIBILITY_SHORTCUT_TARGET" }
	...
	public static var appBrowser: Self { "android.intent.category.APP_BROWSER" }
	...
	public static var appCalculator: Self { "android.intent.category.APP_CALCULATOR" }
	...
	public static var appCalendar: Self { "android.intent.category.APP_CALENDAR" }
	...
	public static var appContacts: Self { "android.intent.category.APP_CONTACTS" }
	...
	public static var appEmail: Self { "android.intent.category.APP_EMAIL" }
	...
	public static var appFiles: Self { "android.intent.category.APP_FILES" }
	...
	public static var appFitness: Self { "android.intent.category.APP_FITNESS" }
	...
	public static var appGallery: Self { "android.intent.category.APP_GALLERY" }
	...
	public static var appMaps: Self { "android.intent.category.APP_MAPS" }
	
	/// This activity allows the user to browse and download new applications.
	///
	/// [Learn more](https://developer.android.com/reference/android/content/Intent#CATEGORY_APP_MARKET)
	public static var appMarket: Self { "android.intent.category.APP_MARKET" }
	...
	public static var appMessaging: Self { "android.intent.category.APP_MESSAGING" }
	...
	public static var appMusic: Self { "android.intent.category.APP_MUSIC" }
	...
	public static var appWeather: Self { "android.intent.category.APP_WEATHER" }
	...
	public static var carDock: Self { "android.intent.category.CAR_DOCK" }
	
	/// Used to indicate that the activity can be used in a car environment.
	///
	/// [Learn more](https://developer.android.com/reference/android/content/Intent#CATEGORY_CAR_MODE)
	public static var carMode: Self { "android.intent.category.CAR_MODE" }
	...
	public static var deskDock: Self { "android.intent.category.DESK_DOCK" }
	
	/// This activity is a development preference panel.
	///
	/// [Learn more](https://developer.android.com/reference/android/content/Intent#CATEGORY_DEVELOPMENT_PREFERENCE)
	public static var developmentPreference: Self { "android.intent.category.DEVELOPMENT_PREFERENCE" }
	...
	public static var frameworkInstrumentationTest: Self { "android.intent.category.FRAMEWORK_INSTRUMENTATION_TEST" }
	...
	public static var heDeskDock: Self { "android.intent.category.HE_DESK_DOCK" }
	...
	public static var leanbackLauncher: Self { "android.intent.category.LEANBACK_LAUNCHER" }
	...
	public static var leDeskDock: Self { "android.intent.category.LE_DESK_DOCK" }
	...
	public static var sampleCode: Self { "android.intent.category.SAMPLE_CODE" }
	...
	public static var secondaryHome: Self { "android.intent.category.SECONDARY_HOME" }
	...
	public static var selectedAlternative: Self { "android.intent.category.SELECTED_ALTERNATIVE" }
	...
	public static var typedOpenable: Self { "android.intent.category.TYPED_OPENABLE" }
	
	/// To be used as a unit test (run through the Test Harness).
	///
	/// [Learn more](https://developer.android.com/reference/android/content/Intent#CATEGORY_UNIT_TEST)
	public static var unitTest: Self { "android.intent.category.UNIT_TEST" }
	...
	public static var vrHome: Self { "android.intent.category.VR_HOME" }
}
