...
extension ComGoogleAndroidPackage.Material.NavigationRailPackage {
...
class NavigationRailView: View {
    override init (_ environment: JEnvironment, _ context: JObjectReference) {
        super.init(environment, context, classes: [.comGoogleAndroid.material.navigationrail.NavigationRailView])
    }
